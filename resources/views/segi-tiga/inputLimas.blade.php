        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3>Hitung Volume Limas</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('limas.hitung') }}" method="post">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="tinggi" class="form-label">Tinggi Alas (Segitiga)</label>
                        ...
                        <div class="mb-3">
                            <label for="tinggi_limas" class="form-label">Tinggi Limas</label>
                            <input type="number" class="form-control @error('tinggi_limas') is-invalid @enderror" 
                                   id="tinggi_limas" name="tinggi_limas" step="0.01" value="{{ old('tinggi_limas') }}" required>
                            @error('tinggi_limas')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
